...
constexpr ServoSpec kServos[] = {
    ...
    {ServoId::Rotation,    "Rotation",    PIN_SERVO_5, 10.0f,              100,                                100.0f,                            -1}, // primary = rotate RearLeft + FrontRight to the right and RearRight + FrontLeft to the left
    {ServoId::Translation, "Translation", PIN_SERVO_6, 10.0f,              150,                                80.0f,                             +1}, // primary = move RearLeft + FrontRight forward and RearRight + FrontLeft backward
};
